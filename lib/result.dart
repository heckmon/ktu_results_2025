  ...
  Widget build(BuildContext context) {
    return studentName != "none"
        ...
        : const AlertDialog(
            ...
            content: Text(
                "The student with the provided register number could not be found in the database.\nThis may also be due to a server error. Please try again later."),
          );
  }
}
