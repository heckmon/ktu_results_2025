    ...
    return MediaQuery.of(context).size.width > 900
        ? AppBar(
            actions: [
              ...
              styledTextButton("Events", FontAwesomeIcons.calendarDays, false,
                  () async {
                await launchUrl(Uri.parse("https://ktu.edu.in/Menu/events"));
              }),
              styledTextButton(
                  "Announcements", FontAwesomeIcons.bullhorn, false, () async {
                await launchUrl(
                    Uri.parse("https://ktu.edu.in/Menu/announcements"));
              }),
              styledTextButton("Gallery", FontAwesomeIcons.solidImage, false,
                  () async {
                await launchUrl(Uri.parse("https://ktu.edu.in/Menu/gallery"));
              }),
              styledTextButton("Contact us", FontAwesomeIcons.globe, false,
                  () async {
                await launchUrl(Uri.parse("https://ktu.edu.in/Menu/contactus"));
              }),
              styledTextButton("Tenders", FontAwesomeIcons.gavel, false,
                  () async {
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: DropdownButton(
                      ...
                      style:
                          const TextStyle(color: Colors.white, fontSize: 12.75),
            ...
            toolbarHeight:
                MediaQuery.of(context).size.width < 600 ? 90.0 : 45.0,
            backgroundColor: const Color.fromARGB(255, 0, 100, 182),
          )
        : AppBar(
            title: Row(
              children: [
                styledTextButton("", FontAwesomeIcons.calendarDays, true, () {})
              ],
            ),
          );
  }
